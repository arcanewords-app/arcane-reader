...
/* Mobile */
.btn { min-height: 40px; padding: 0.5rem 0.75rem; }

/* Small Mobile */
.btn { min-height: 36px; padding: 0.375rem 0.625rem; }

/* Extra Small */
.btn { min-height: 32px; padding: 0.25rem 0.5rem; }
```
...
/* Mobile */
@media (max-width: 767px) { gap: 0.5rem; }
