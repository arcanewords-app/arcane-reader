...
Last updated: 2026-09-13 (monthly P0+P3 + Stryker 10 + openai 7 + axiom 2 / web-vitals 6).

## npm audit --omit=dev (production)

- **0 vulnerabilities**
- Runtime: `express@5`, `openai@7`, `@axiomhq/js@2`, Node 24, `multer@2.3`, `csv-parse@7.0.2`, `fast-xml-parser@5.11`, `adm-zip@0.6.1` (override so `epub2` does not keep 0.5)
...
- **Applied:** monthly P3 (Vite 8.3, oxlint 1.82, supabase-js 2.116, openai 7.15, `@axiomhq/js` 2.0, `web-vitals` 6.2, zod 4.6, …) + P0 security patches
