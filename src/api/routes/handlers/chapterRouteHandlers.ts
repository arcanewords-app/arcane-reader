...
import {
  addGlossaryEntry,
  updateGlossaryEntry,
} from '../../../services/supabase/domains/glossary.js';
...
export async function handleGetChapterStatus(req: Request, res: Response) {
  try {
    if (!req.user) {
...
export async function handleGetChapter(req: Request, res: Response) {
  try {
    if (!req.user) {
      return res.status(401).json({ error: 'Unauthorized' });
    }
...
export async function handleDeleteChapter(req: Request, res: Response) {
  try {
    if (!req.user) {
      return res.status(401).json({ error: 'Unauthorized' });
    }
...
export async function handleDuplicateChapters(req: Request, res: Response) {
  try {
    if (!req.user) {
      return res.status(401).json({ error: 'Unauthorized' });
    }
...
export async function handleBulkDeleteChapters(req: Request, res: Response) {
  try {
    if (!req.user) {
      return res.status(401).json({ error: 'Unauthorized' });
    }
...
export async function handleCancelTranslation(req: Request, res: Response) {
  try {
    if (!req.user) {
      return res.status(401).json({ error: 'Unauthorized' });
    }
...
export async function handleSyncTranslation(req: Request, res: Response) {
  try {
    if (!req.user) {
      return res.status(401).json({ error: 'Unauthorized' });
    }
...
export async function handleUploadTranslation(req: Request, res: Response) {
  try {
    if (!req.user) {
      return res.status(401).json({ error: 'Unauthorized' });
    }
...
export async function handleMarkAsTranslated(req: Request, res: Response) {
  try {
    if (!req.user) {
      return res.status(401).json({ error: 'Unauthorized' });
    }
...
export async function handleMarkAsTranslatedBatch(req: Request, res: Response) {
  try {
    if (!req.user) {
      return res.status(401).json({ error: 'Unauthorized' });
    }
...
export function createHandleAnalyzeBatch(deps: RouteDeps) {
...
export function createHandleListProjectJobs(deps: RouteDeps) {
  return async (req: Request, res: Response) => {
...
export function createHandleGetAnalysisJobStatus(deps: RouteDeps) {
  return async (req: Request, res: Response) => {
    if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
...
export function createHandleCancelAnalysisJob(deps: RouteDeps) {
  return async (req: Request, res: Response) => {
    try {
      if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
      const job = await deps.analysisJobStore.getJob(requireRouteParam(req.params.jobId, 'jobId'));
...
export function createHandleTranslateBatch(deps: RouteDeps) {
  return async (req: Request, res: Response) => {
    try {
      if (!req.user) {
        return res.status(401).json({ error: 'Unauthorized' });
...
export function createHandleGetTranslateJobStatus(deps: RouteDeps) {
  return async (req: Request, res: Response) => {
    if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
...
export function createHandleCancelTranslateJob(deps: RouteDeps) {
  return async (req: Request, res: Response) => {
    try {
      if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
      const job = await deps.translateJobStore.getJob(requireRouteParam(req.params.jobId, 'jobId'));
...
export function createHandleTranslateChapter(deps: RouteDeps) {
  return async (req: Request, res: Response) => {
    try {
      if (!req.user) {
        return res.status(401).json({ error: 'Unauthorized' });
...
export async function handleChapterCritic(req: Request, res: Response) {
  try {
    if (!req.user) {
      return res.status(401).json({ error: 'Unauthorized' });
    }
    ...
    if (!force && chapter.criticReport && chapter.criticReport.contentFingerprint === fingerprint) {
...
export async function handleGetChapterStats(req: Request, res: Response) {
  try {
    if (!req.user) {
      return res.status(401).json({ error: 'Unauthorized' });
    }
...
export async function handleUpdateChapterTitle(req: Request, res: Response) {
  try {
    if (!req.user) {
      return res.status(401).json({ error: 'Unauthorized' });
    }
...
export async function handleUpdateChapterNumber(req: Request, res: Response) {
  try {
    if (!req.user) {
      return res.status(401).json({ error: 'Unauthorized' });
    }
...
export async function handleUpdateChapterStatus(req: Request, res: Response) {
  try {
    if (!req.user) {
      return res.status(401).json({ error: 'Unauthorized' });
    }
    ...
    const errorMessage = error instanceof Error ? error.message : 'Failed to update chapter status';
    res.status(500).json({ error: errorMessage });
  }
}

export async function handleUpdateChaptersOrder(req: Request, res: Response) {
  try {
    if (!req.user) return res.status(401).json({ error: 'Unauthorized' });
...
export async function handleUpdateParagraph(req: Request, res: Response) {
  try {
