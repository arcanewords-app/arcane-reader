...
function BookPlaceholderSVG({
  ...
  colors: ReturnType<typeof generateColorPalette>;
  uniqueId: string;
}) {
  ...
  return (
    ...
    >
      ...
      {/* Pattern overlay */}
      <rect width="200" height="300" fill={`url(#${pattern}Pattern-${uniqueId})`} />
...
function TextPlaceholderSVG({
  ...
  return (
    ...
    >
      ...
      <path d="M 160 0 L 200 0 L 200 40 L 160 0 Z" fill={accent} opacity="0.2" />
